class Semaforo {
    ...
    createRecordForm(timeDifference) {
        ...
        var labelSurname = document.createElement("h4")
        labelSurname.appendChild(document.createTextNode("Apellidos:"))
        var labelReactionTime = document.createElement("h4")
        labelReactionTime.appendChild(document.createTextNode("Reacción:"))
        var labelDifficulty = document.createElement("h4")
        labelDifficulty.appendChild(document.createTextNode("Dificultad:"))

        var sectionName = document.createElement("section")
        var sectionSurname = document.createElement("section")
        var sectionReactionTime = document.createElement("section")
        var sectionDifficulty = document.createElement("section")
        ...
        sectionSurname.appendChild(labelSurname)
        sectionSurname.appendChild(inputSurname)
        sectionReactionTime.appendChild(labelReactionTime)
        sectionReactionTime.appendChild(inputReactionTime)
        sectionDifficulty.appendChild(labelDifficulty)
        sectionDifficulty.appendChild(inputDifficulty)

        form.appendChild(sectionName)
        form.appendChild(sectionSurname)
        form.appendChild(sectionReactionTime)
