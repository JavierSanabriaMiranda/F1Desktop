class Semaforo {
    ...
    createRecordForm(timeDifference) {
        ...
        inputSurname.setAttribute("id", "apellidos")
        ...
        inputReactionTime.setAttribute("id", "tiempo")
        ...
        inputDifficulty.setAttribute("id", "dificultad")
